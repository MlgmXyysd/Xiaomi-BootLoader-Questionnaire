...
- **由于个别小米员工采用不正当方式在答题时段频繁修改答题内容、修改题目并更换选项，导致用户答题过程中正确选项被替换为错误选项，严重破坏了答题的公平性。受此影响，近期答题通过率有所下降。因此，我们在此呼吁各位有解锁需求的小米用户共同抵制上述违规行为，营造良性答题环境。待相关员工被批评/开除，且答题难度合理、解锁审核通过率提升后，我们会考虑逐步降低抨击力度。**
