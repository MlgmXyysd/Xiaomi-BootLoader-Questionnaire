...
- 注:
  ...
  9. 用户若出现下列情形，将无法通过解锁审核:
    ...
    - 其他违反小米账号使用协议的相关情形。
  10. 风险提示: BL 解锁危害多，BL 解锁可能造成各类 App 无法正常使用、个人数据信息泄露、手机变砖、资产损失等情况，因此强烈建议您非必要情况不申请 BL 解锁。
- 官方提示(更新):
  1. 填空题务必不要复制粘贴其他网站的答案，答案雷同或相似度高，将视为无效问卷，无法获得分数;
  2. 目前已有多名用户采用第三方网站上提供的答案，被系统判定为雷同试卷，影响后续资格申请，请谨慎作答;
...
- 注:
  ...
  10. 用户若出现下列情形，将无法通过解锁审核:
    ...
    - 不填写申请理由、或使用AI生成申请理由、或申请理由出现过辱骂威胁等内容;
    - 其他违反小米账号使用协议的相关情形。
  11. 风险提示: BL 解锁危害多，BL 解锁可能造成各类 App 无法正常使用、个人数据信息泄露、手机变砖、资产损失等情况，因此强烈建议您非必要情况不申请 BL 解锁。
- 官方提示(更新):
  1. 填空题务必不要复制粘贴其他网站的答案，答案雷同或相似度高，将视为无效问卷，无法获得分数;
  2. 填空题采用人工阅卷方式，人工阅卷预计在【下一答题周期开始前】完成;
  3. 您提交问卷时的实时成绩仅为【选择题得分】;
...
- 注(更新):
  ...
  11. 风险提示: BL 解锁危害多，BL 解锁可能造成各类 App 无法正常使用、个人数据信息泄露、手机变砖、资产损失等情况，因此强烈建议您非必要情况不申请 BL 解锁。
- 官方提示(更新):
  1. 填空题采用人工阅卷方式，人工阅卷预计在【下一答题周期开始前】完成;
  2. 您提交问卷时的实时成绩仅为【选择题得分】;
  3. 人工阅卷后，如您的【选择题 + 填空题总分】未达到分数线时，您的成绩将仅展示【选择题得分】;
  4. 人工阅卷后，如您的【选择题 + 填空题总分】达到分数线时，您的成绩将展示为【选择题 + 填空题总分】;
  5. 请务必通过“小米社区 App-内测中心-BL 解锁申请-去答题”进入本次答题界面并完成答题，未使用小米社区 App 进行答题将视为无效答题，无法展示成绩;
  6. 等级未达 5 段，无法展示成绩;
  7. 答题超时提交，无法展示成绩;
  8. 请您充分知晓解锁和刷机存在的风险，并在可承担该风险的情况下申请 Bootloader 解锁。
